...
exports.setUser = async (req, res) => {
    ...
    try {
        ...
        if (!existingUserData) {
            ...
            if (canvas_courses) {
                const canvas_courses_error = ensure_canvas_courses_type(canvas_courses);
                if (canvas_courses_error) return res.send({ message: canvas_courses_error });
            }
            if (settings) {
            ...
            if (user_stats) {
                ...
                if (user_stats_error) return res.send({ message: user_stats_error });
            }
